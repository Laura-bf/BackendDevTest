...
import com.AMS.backendDevTest.model.dtos.*;
...
public class SimilarProductsController {
	...
	public Flux<ProductDetailDto> getSimilarProdsById(@PathVariable(value = "productId") String id){

		return similarProdsService.getSimilarProds(id);
	}
}
